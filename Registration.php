...
.card-signin .card-img-left {
  ...
  background: scroll center url('https://1.bp.blogspot.com/-L5qL_NGg09Q/XAkXODacQiI/AAAAAAAAAAM/SmAEiqfnIdoIVw8mulHMc7xTPj-wzLYigCLcBGAs/s640/aged%2Bcare%2Bdoctor.jpg');
        ...
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            ...
            <form class="form-signin" action="addContacts.php" method="POST" id="fileForm" role="form" enctype="multipart/form-data">
              ...
              <div class="form-label-group">
                <input type="text" id="inputLastame" class="form-control" placeholder="Lastname" required autofocus>
              ...
              <div class="form-label-group">
                <input type="text" id="inputSkype" class="form-control" placeholder="Skype Id" required>
                <label for="inputSkype">Skype Id</label>
              </div>

              <div class="form-label-group">
                <input type="phone" id="inputPhone" class="form-control" placeholder="Phone no.">
